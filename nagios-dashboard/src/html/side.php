...
<div class="navsection">
	<div class="navsectiontitle">Edgecore Dashboard</div>
		<li><a href="<?php echo $cfg["cgi_base_url"];?>/ec_host_status.cgi?host=all" target="<?php echo $link_target;?>">Host Status</a></li>
		<!--<li><a href="ec_demo.php" target="<?php echo $link_target;?>">Demonstration</a></li>-->
</div>
